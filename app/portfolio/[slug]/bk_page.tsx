...
// 1. IMPORTA LA LIGHTBOX E I SUOI STILI
...
export default function DettaglioProgetto() {
  ...
  // Stato della Lightbox (gestisce l'apertura/chiusura)
                ...
                >
                  {itemsInBlocco.map((item: any, indexImg) => {
                    ...
                    return (
                      <div
                        key={indexImg}
                        onClick={() => setIndex(posizioneGlobale)} // Al click imposta l'indice globale ed apre l'overlay
                        className={spanClasses}
                      >
                        <ImmagineAnimata
                          item={item}
