    ...
    return (React.createElement("section", { id: "contatti", className: "bg-grigio-light p-0 pb-12 lg:pb-0 lg:pt-16 pt-8 border-b border-grigio-chiaro" },
        React.createElement("div", { className: "container-site w-full p-0" },
            React.createElement(framer_motion_1.motion.div, { className: "col-span-full text-center mb-12", variants: animations_1.bounceIn, initial: "hidden", whileInView: "visible", viewport: viewportConfig },
                React.createElement("span", { className: "font-mono text-xs uppercase tracking-widest text-navy" }, "Vuoi fare due chiacchere?"),
                React.createElement("h2", { className: "font-semibold text-grigio-scuro title-line" }, "Contattami")),
            React.createElement(framer_motion_1.motion.div, { variants: animations_1.containerVariants, initial: "hidden", whileInView: "visible", viewport: viewportConfig, className: "grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start lg:pr-16" },
                React.createElement(framer_motion_1.motion.div, { variants: animations_1.revealLeftToRight, className: "lg:col-span-5 flex justify-center lg:justify-start" },
                    React.createElement("div", { className: "relative w-full max-w-100 aspect-3/4 lg:max-w-full" },
                ...
                React.createElement("div", { className: "lg:col-span-7 space-y-8 px-6 lg:px-0" },
                    React.createElement(framer_motion_1.motion.div, { variants: animations_1.bounceIn },
                    ...
                    React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4" },
                        React.createElement(framer_motion_1.motion.div, { variants: animations_1.fadeInLeft, className: "bg-bianco border border-grigio-chiaro/60 rounded-2xl p-6 shadow-sm flex flex-col gap-4" },
                        ...
                        React.createElement(framer_motion_1.motion.div, { variants: animations_1.fadeInRight, className: "bg-bianco border border-grigio-chiaro/60 rounded-2xl p-6 shadow-sm flex flex-col gap-4" },
                        ...
                        React.createElement(framer_motion_1.motion.div, { variants: animations_1.fadeInUp, className: "sm:col-span-2 bg-bianco border border-grigio-chiaro/60 rounded-2xl p-6 shadow-sm flex flex-col gap-4" },
