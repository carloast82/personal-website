...
export const portfolioItems: PortfolioItem[] = [
  // --- BLOCCO 1 ---
  {
    ...
    descrizione:
      "Il mio portfolio personale e CV online. Un progetto nato per presentare le mie esperienze e competenze in modo chiaro e diretto, con un design pulito ed elementi interattivi curati.",
    tecnologie: ["Next.js", "Tailwind CSS", "Framer Motion", "Figma", "Gemini", "Copilot"],
    notaCrediti:
      "",
    immaginiDettaglio: [
      {
  ...
  
  {
    ...
    attivita: ["Web design", "UI design", "SEO", "Sviluppo", "Data Entry", "DB Management"],
    descrizione:
    ...
    tecnologie: ["Photoshop", "Illustrator", "PHP", "HTML5", "SCSS", "Javascript", "MySql"],
    notaCrediti:
