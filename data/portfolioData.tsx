...
Ogni pagina è stata strutturata per garantire armonia visiva, fluidità di navigazione e una chiara gerarchia delle informazioni. Il progetto è stato interamente finalizzato a livello di mockup visivo e non ha previsto una successiva fase di sviluppo tecnico o pubblicazione online.`,
  ...
  // --- BLOCCO 2 ---
  {
    ...
    immaginiDettaglio: [
      {
        path: "/images/portfolio/fondazione-irisceramicagroup/fondazione.irisceramicagroup.com_.webp",
      ...
      {
        path: "/images/portfolio/fondazione-irisceramicagroup/fondazione.irisceramicagroup.com_fondazione_associazioni_sea-shepherd-italia_.webp",
        alt: "Fondazione Iris Ceramica Group",
        blocco: 1,
        sequenza: 1,
        mdRowSpan: 4,
      ...
      {
        path: "/images/portfolio/fondazione-irisceramicagroup/fondazione.irisceramicagroup.com_fondazione_associazioni_save-the-children_.webp",
        alt: "Fondazione Iris Ceramica Group",
        blocco: 1,
        sequenza: 1,
        mdRowSpan: 2,
      ...
      {
        path: "/images/portfolio/fondazione-irisceramicagroup/fondazione.irisceramicagroup.com_fondazione_impegno_.webp",
        alt: "Fondazione Iris Ceramica Group",
        blocco: 1,
        sequenza: 1,
        mdRowSpan: 2,
      ...
      {
        path: "/images/portfolio/fondazione-irisceramicagroup/fondazione.irisceramicagroup.com_fondazione_semi-di-futuro_.webp",
        alt: "Fondazione Iris Ceramica Group",
        blocco: 2,
        sequenza: 1,
        mdRowSpan: 3,
      ...
      {
        path: "/images/portfolio/fondazione-irisceramicagroup/fondazione.irisceramicagroup.com_fondazione_museo_.webp",
        alt: "Fondazione Iris Ceramica Group",
        blocco: 2,
        sequenza: 1,
        mdRowSpan: 4,
  ...
  // --- BLOCCO 3 ---
  {
    ...
    immaginiDettaglio: [
      {
        path: "/images/portfolio/enrico-capra/www.enricocapra.com_.webp ",
        alt: "Enrico Capra",
        blocco: 1,
        sequenza: 1,
        mdRowSpan: 4,
      ...
      {
        path: "/images/portfolio/enrico-capra/www.enricocapra.com_collezioni_.webp ",
        alt: "Enrico Capra",
        blocco: 1,
        sequenza: 1,
        mdRowSpan: 4,
      ...
      {
        path: "/images/portfolio/enrico-capra/www.enricocapra.com_azienda_.webp ",
        alt: "Enrico Capra",
        blocco: 1,
        sequenza: 1,
        mdRowSpan: 4,
      ...
      {
        path: "/images/portfolio/enrico-capra/www.enricocapra.com_ispirazione_.webp ",
        alt: "Enrico Capra",
        blocco: 2,
        sequenza: 1,
        mdRowSpan: 3,
      ...
      {
        path: "/images/portfolio/enrico-capra/www.enricocapra.com_contatti_.webp",
        alt: "Enrico Capra",
        blocco: 2,
        sequenza: 1,
        mdRowSpan: 2,
