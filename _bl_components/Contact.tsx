  ...
  return (
    ...
    >
      <div className="container-site w-full p-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start lg:pr-16">
          {/* COLONNA SINISTRA: FOTO PORTRAIT (Senza sfondi per fondersi con la pagina) */}
          <div className="lg:col-span-5 flex justify-center lg:justify-start">
            <div className="relative w-full max-w-[400px] aspect-[3/4] lg:max-w-full">
              <Image
          ...
          <div className="lg:col-span-7 space-y-8 px-6 lg:px-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* CARD 1: EMAIL */}
              <div className="bg-bianco border border-grigio-chiaro/60 rounded-2xl p-6 shadow-sm flex flex-col gap-4">
              ...
              <div className="sm:col-span-2 bg-bianco border border-grigio-chiaro/60 rounded-2xl p-6 shadow-sm flex flex-col gap-4">
